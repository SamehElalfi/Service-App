          ...
          <div class="card-body">
            <form class="form-horizontal" action="/dashboard/users" method="POST">
              <fieldset>
                ...
                <? component('dashboard/input', ['title'=>'First Name', 'name'=>'first_name', 'required'=>true]) ?>
                <? component('dashboard/input', ['title'=>'Last Name', 'name'=>'last_name', 'required'=>true]) ?>
                <? component('dashboard/input', ['title'=>'E-mail', 'name'=>'email', 'type'=>'email', 'required'=>true]) ?>
